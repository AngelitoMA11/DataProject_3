...
flights_tool = ToolNode(
    name="flights_finder",
    description="Find flight information using Google Flights via SerpApi. Returns a list of flight details.",
    function=flights_finder,
    input_schema=FlightsInput
)